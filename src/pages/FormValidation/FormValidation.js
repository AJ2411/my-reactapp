            ...
            <div className="col-sm-12 main__content">
                ...
                <form>
                    ...
                    <div className='form-group row'>
                        ...
                        <div className='col-6'>
                            <input type='text' name='emailAddress' value={this.state.emailAddress} placeholder='ex., Newcustomer@gmail.com' className='form-control' onChange={this.handleUserInput} />
                        </div>
                    </div><br></br><br></br>
                    ...
                    <div className='form-group row'>
                        ...
                        <div className='col-6'>
                            <input type='text' name='password' value={this.state.password} placeholder='ex.,Welcome123' className='form-control' onChange={this.handleUserInput} />
                        </div>
                    </div><br></br><br></br>
